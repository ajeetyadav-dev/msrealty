    ...
    public function collection(): Collection
    {
        ...
        $sampleProjects = [
            [
                ...
                'categories' => 'Apartment,House,Villa,Independent Builder Floor,Plot,Land,Studio Apartment,Serviced Apartment,Farmhouse,PG,Condo,Office Space,Shop,Showroom,Warehouse,Industrial Land,Commercial,Other',
