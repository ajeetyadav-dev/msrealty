<style>
    ...
    .skeleton-property-title {
        height: 20px;
        margin-bottom: 10px;
        border-radius: 4px;
    }

    .skeleton-property-location {
        height: 16px;
        width: 70%;
        margin-bottom: 15px;
        border-radius: 4px;
    ...
    .skeleton-property-features {
        display: flex;
        gap: 15px;
        margin-bottom: 15px;
    }

    .skeleton-property-feature {
        height: 16px;
        width: 50px;
        border-radius: 4px;
    }

    .skeleton-property-price {
        height: 24px;
        width: 40%;
        border-radius: 4px;
    }
                ...
                @for ($i = 0; $i < 8; $i++)
                    <div class="col-sm-6 col-lg-4 col-xl-3 colm10">
                        <div class="skeleton-property-card">
                            <div class="skeleton-property-image skeleton-loading-bg">
                                <div class="skeleton-property-badge skeleton-loading-bg"></div>
                            </div>
                            <div class="skeleton-property-content">
                                <div class="skeleton-property-title skeleton-loading-bg"></div>
                                <div class="skeleton-property-location skeleton-loading-bg"></div>
                                <div class="skeleton-property-features">
                                    <div class="skeleton-property-feature skeleton-loading-bg"></div>
                                    <div class="skeleton-property-feature skeleton-loading-bg"></div>
                                    <div class="skeleton-property-feature skeleton-loading-bg"></div>
                                </div>
                                <div class="skeleton-property-price skeleton-loading-bg"></div>
                            </div>
                        </div>
                    </div>
                @endfor
