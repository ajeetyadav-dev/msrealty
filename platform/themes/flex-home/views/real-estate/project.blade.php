            ...
            <div class="col-12">
                ...
                <p class="addresshouse">
                    ...
                    <span class="d-inline-block"><i class="fa fa-calendar-alt"></i>
                        {{ Theme::formatDate($project->created_at) }}</span>
                </p>
                <div class="d-none">
        ...
        <section class="general">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-sm-6 lineheight220">
                            @if ($lastUpdated = $project->getMetaData('last_updated', true))
                                <div><span>{{ __('Last Updated') }}:&nbsp;</span> <strong>{{ rescue(fn () => Theme::formatDate($lastUpdated)) }}</strong></div>
                            @endif
                    ...
                    @endif
                    @if(($project->can_see_private_notes ?? false) && ($project->private_notes ?? null))
                        <div class="alert alert-primary mt-3" role="alert">
                            <h6 class="alert-heading mb-2">{{ __('Private Notes') }}</h6>
                            <div style="font-size: 0.9rem;">
                                {!! BaseHelper::clean(nl2br($project->private_notes)) !!}
                            </div>
                        </div>
                    @endif
                ...
                <div class="col-md-4 padtop10">
                    ...
                    {!! dynamic_sidebar('project_detail_sidebar') !!}
                </div>
            </div>
