...
register_sidebar([
    ...
    'name' => __('Property Detail sidebar'),
    'description' => __('Widgets displayed on property detail page'),
]);

register_sidebar([
    'id' => 'project_detail_sidebar',
    'name' => __('Project Detail sidebar'),
    'description' => __('Widgets displayed on project detail page'),
]);
...
app()->booted(function (): void {
    ...
    if (is_plugin_active('real-estate')) {
        ...
        add_action(BASE_ACTION_META_BOXES, function ($context, $object) use ($videoSupportModels): void {
        ...
        add_action([BASE_ACTION_AFTER_CREATE_CONTENT, BASE_ACTION_AFTER_UPDATE_CONTENT], function ($type, $request, $object) use ($videoSupportModels): void {
            ...
            if ($request->has('last_updated')) {
                ...
                if (empty($lastUpdated)) {
                    MetaBox::deleteMetaData($object, 'last_updated');
                } else {
                    MetaBox::saveMetaBoxData($object, 'last_updated', $lastUpdated);
                }
            }
        }, 280, 3);
