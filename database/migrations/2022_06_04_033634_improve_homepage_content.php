    ...
    public function up(): void
    {
        ...
        if ($homepageId) {
            ...
            if ($homepage) {
                ...
                $homepage->content = str_replace('[properties-for-pg][/properties-for-pg]', '[properties-for-pg title="' . __('Properties For Pg') . '" subtitle="' . theme_option('home_description_for_properties_for_pg') . '"][/properties-for-pg]', $homepage->content);
